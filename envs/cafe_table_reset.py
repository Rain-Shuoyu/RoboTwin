...
class cafe_table_reset(Base_Task):
    ...
    def load_actors(self):
        ...
        self.cup = actor("021_cup", [-0.28, -0.25, 0.741], quat=[0.5, 0.5, 0.5, 0.5])
        self.mug = actor("039_mug", [0.00, -0.25, 0.741], quat=[0.5, 0.5, 0.5, 0.5])
        self.plate = actor("003_plate", [0.28, -0.25, 0.741], quat=[0.5, 0.5, 0.5, 0.5])
